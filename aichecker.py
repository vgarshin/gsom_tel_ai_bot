...
creds = read_credentials('credentials_checker.json')
USER = creds['db_user']
...
def start():
    ...
    Ваша задача - проверять ответы студентов на домашнее задание,
    указать на ошибки и дать развернутую обратную связь.
    """
    llm = YandexLLM(
        iam_token=token,
